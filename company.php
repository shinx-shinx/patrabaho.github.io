...
<head>
	...
	<title>LRN Pa Trabaho - <?php echo "$compname"; ?></title>
									...
									<div class="company-detail-header text-center">
										...
										<ul class="meta-list clearfix">
											...
											<li>
												...
												<a target="_blank" href="https://<?php echo "$compmail"; ?>"><?php echo "$compmail"; ?></a>
											</li>
										</ul>
