...
$slc_category = "$cate";
$title = "$slc_category jobs in $slc_barangay";
}else{
...
<head>
	...
	<title>LRN - <?php echo "$title"; ?></title>
	...
	<link rel="shortcut icon" href="images/ico/lrnlogo.png">
			...
			<nav class="navbar navbar-default navbar-fixed-top navbar-sticky-function">
				...
				<div class="container">
					...
					<div class="logo-wrapper">
						<div class="logo">
							<a href="./"><img src="images/plogo.png" alt="Logo" /></a>
						</div>
					</div>
					...
					<div class="nav-mini-wrapper">
						...
						print '
							...
							<li><a data-toggle="modal" href="register.php?">register</a></li>';						
						}
								...
								<div class="col-xss-12 col-xs-6 col-sm-6 col-md-5">
									<div class="form-group form-lg">
										...
										<option value="">-Select barangay-</option>
                                         ...
                                         {
											  $cnt = $row['barangay_name'];
                                        ?>
										
										<option <?php if ($slc_barangay == "$cnt") { print ' selected '; } ?> value="<?php echo $row['barangay_name']; ?>"><?php echo $row['barangay_name']; ?></option>
										<?php
	                                     }
                                         $stmt->execute();
					...
					<div class="result-wrapper">
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-12 mt-25">
								...
								print '<li class="paging-nav" '; if ($page == "1") { print 'class="disabled"'; } print '><a '; if ($page == "1") { print ''; } else { print 'href="job-list.php?page='.$prevpage.''; ?> <?php if ($fromsearch == true) { print '&category='.$cate.'&barangay='.$barangay.'&search=✓'; }'';} print '"><i class="fa fa-chevron-left"></i></a></li>';
					            for ($b=1;$b<=$records;$b++)
                                 {
                                 
		                        ?><li  class="paging-nav" ><a <?php if ($b == $page) { print ' style="background-color:#33B6CB; color:white" '; } ?>  href="job-list.php?page=<?php echo "$b"; ?><?php if ($fromsearch == true) { print '&category='.$cate.'&barangay='.$barangay.'&search=✓'; }?>"><?php echo $b." "; ?></a></li><?php
                                 }	
								 print '<li class="paging-nav"'; if ($page == $records) { print 'class="disabled"'; } print '><a '; if ($page == $records) { print ''; } else { print 'href="job-list.php?page='.$nextpage.''; ?> <?php if ($fromsearch == true) { print '&category='.$cate.'&barangay='.$barangay.'&search=✓'; }'';} print '"><i class="fa fa-chevron-right"></i></a></li>';
					             }
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About LRN Pa Trabaho</h5>
											<p>LRN Pa Trabaho system is an online system that provides a means for clients and freelancers around the city to collaborate for mutual benefit.</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">LRN Jobs Contact</h5>
								
								<p>Address : Calbayog City, Samar Province</p>
								<p>Email : <a href="mailto:linux.gaming20@gmail.com">linux.gaming20@gmail.com</a></p>
