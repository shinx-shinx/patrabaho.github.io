		...
		<div class="main-wrapper">
			...
			<div class="hero" style="background-image:url('images/hero-header/homecover.jpeg'); background-position: top;">
				<div class="container">
					...
					<p>Never lose hope! Because there's always a new job post.</p>
							...
							<div class="form-holder">
								<div class="row gap-0">
									...
									<div class="col-xss-6 col-xs-6 col-sm-6">
										...
										<option style="color:black" value="<?php echo $row['barangay_name']; ?>"><?php echo $row['barangay_name']; ?></option>
										<?php
	                                     }
                                         $stmt->execute();
