...
<head>
	...
	<title>LRN PaTrabaho - Professional Qualifications</title>
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
									...
									<option disabled value="">Select</option>
										...
										<option <?php if ($cbarangay == $row['barangay_name'] ) { print ' selected '; } ?> value="<?php echo $row['barangay_name']; ?>"><?php echo $row['barangay_name']; ?></option>
										<?php
	                                     }
                                         $stmt->execute();
