...
<head>
	...
	<title>LRN - Profile</title>
	<meta name="description" content="Online Job Management / Job Portal" />
	<meta name="keywords" content="job, work, resume, applicants, application, employee, employer, hire, hiring, human resource management, hr, online job management, employer, worker, career, recruiting, recruitment" />
				...
				<div class="container">
					...
					<div id="navbar" class="navbar-nav-wrapper navbar-arrow">
						...
						<ul class="nav navbar-nav" id="responsive-menu">
							...
							<li>
								<a href="../employees.php">Freelancer</a>
							</li>
							...
							<div class="GridLex-col-3_sm-4_xs-12">
								...
								<div class="admin-sidebar">
									...
									<div class="admin-user-item for-employer">
										...
										<?php 
										if ($logo == null) {
										print '<center>Employer Profile Here</center>';
										}else{
									...
									<form class="post-form-wrapper" action="app/update-profile.php" method="POST" autocomplete="off">
											...
											<div class="row gap-20">
												...
												<div class="col-sm-6 col-md-4">
													...
													<div class="form-group">
														<label>Employer Age</label>
                                                    <input name="year" placeholder="Enter year age" type="text" class="form-control" value="<?php echo "$esta"; ?>" required>
													</div>
