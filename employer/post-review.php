...
elseif($_SESSION['role'] != 'employer') $disabled = 'disabled'; 
...
try{
    ...
    $stmt->bindParam(':ref_no', $_GET['empid']);
...
<div class="GridLex-col-9_sm-8_xs-12">	    
    <form action="employer/app/post-review.php" method="POST" enctype="multipart/form-data">			
        <input type="hidden" name="ref_no" value="<?php echo "$empid"; ?>">
    ...
    <div class="form-group">
        <div class="file-drop-zone margin-zero" style="margin: 30px !important; background-color: #fffbf8; height: 100px;">
            ...
            <div class="col-sm-6 col-md-10">
                <a href="?empid=<?php echo $_GET['empid']?>&rating=all" class="<?php echo $_GET['rating'] == 'all' ? 'active-filter' : '' ?>">
                    <div class="col-sm-6 col-md-1 star-filter" id="all">
                        ALL
                    </div>
                </a>
                <a href="?empid=<?php echo $_GET['empid']?>&rating=1" class="<?php echo $_GET['rating'] == '1' ? 'active-filter' : '' ?>">
                    <div class="col-sm-6 col-md-1 star-filter" id="1-star">
                        ⭐
                    </div>
                </a>
                <a href="?empid=<?php echo $_GET['empid']?>&rating=2" class="<?php echo $_GET['rating'] == '2' ? 'active-filter' : '' ?>">
                    <div class="col-sm-6 col-md-1 star-filter" id="2-star">
                        ⭐⭐
                    </div>
                </a>
                <a href="?empid=<?php echo $_GET['empid']?>&rating=3" class="<?php echo $_GET['rating'] == '3' ? 'active-filter' : '' ?>">
                    <div class="col-sm-6 col-md-1 star-filter" id="3-star">
                        ⭐⭐⭐
                    </div>
                </a>
                <a href="?empid=<?php echo $_GET['empid']?>&rating=4" class="<?php echo $_GET['rating'] == '4' ? 'active-filter' : '' ?>">
                    <div class="col-sm-6 col-md-2 star-filter" id="4-star">
                        ⭐⭐⭐⭐
                    </div>
                </a>
                <a href="?empid=<?php echo $_GET['empid']?>&rating=5" class="<?php echo $_GET['rating'] == '5' ? 'active-filter' : '' ?>">
