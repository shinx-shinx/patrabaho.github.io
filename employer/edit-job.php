...
<head>
	...
	<title>LRN PaTrabaho - <?php echo "$jobtitle"; ?></title>
					...
					<div class="row">
							...
							<div class="col-sm-5 col-md-4">
								...
								<div class="company-detail-sidebar">
									...
									<p class="location"><i class="fa fa-map-marker"></i> <?php echo "$zip"; ?> <?php echo "$city"; ?>. <?php echo "$street"; ?>, <?php echo "$mybarangay"; ?> <span class="block"> <i class="fa fa-phone"></i> <?php echo "$myphone"; ?></span></p>
									
									<ul class="meta-list clearfix">
										<li>
											<h4 class="heading">Employer Age:</h4>
											<?php echo "$esta"; ?> -year-old
										</li>
										<li>
										...
										<li>
											<h4 class="heading">Number of man power:</h4>
											<?php echo "$mypeople"; ?>
										</li>
										<li>
												...
												<div class="col-xss-12 col-xs-6 col-sm-6 col-md-4">
													...
													<div class="form-group mb-20">
														...
														<select name="experience" required class="selectpicker show-tick form-control" data-live-search="false" data-selected-text-format="count > 3" data-done-button="true" data-done-button-text="OK" data-none-selected-text="All">
															...
															<option <?php if ($experience == "No Experince") { print ' selected '; } ?> value="No Experince">No Experience</option>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<p>il Ema: <a href="mailto:linux.gaming20@gmail.com">linux.gaming20@gmail.com</a></p>
