					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> 6710, <br/> Calbayog City, <br/>Samar Province</address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:linux.gaming20@gmail.com">linux.gaming20@gmail.com</a>
								</li>
								<li>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<p>Email : <a href="mailto:nightingale.nath2@gmail.com">linux.gaming20@gmail.com</a></p>
