...
<head>
	...
	<title>LRN - <?php echo "$myfname"; ?> <?php echo "$mylname"; ?></title>
			...
			<div id="registerModal" class="modal fade login-box-wrapper" tabindex="-1" style="display: none;" data-backdrop="static" data-keyboard="false" data-replace="true">
				...
				<div class="modal-body">
					...
					<div class="row gap-20">
						...
						<div class="col-sm-6 col-md-6">
							<a href="register.php?p=Employee" class="btn btn-facebook btn-block mb-5-xs">Register as Freelancers</a>
						</div>
									...
									<div class="employee-detail-company-overview mt-40 clearfix">
										...
										<div class="row">
											...
											<div class="col-sm-12">
												...
												<p class="text-muted font-italic">Level - <?php echo $row['level']; ?> , <?php echo $row['timeframe']; ?><span class="font600 text-primary"> <?php echo $row['institution']; ?></span> <?php echo $row['barangay']; ?></p>
										...
										<h3>Professional Qualifications</h3>
											    ...
											    <li>
												<h5><?php echo $row['title']; ?> </h5>
												<p class="text-muted font-italic"><?php echo $row['timeframe']; ?><span class="font600 text-primary"> <?php echo $row['institution']; ?></span> <?php echo $row['barangay']; ?></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<p>Email : <a href="mailto:lnux.gaming20@gmail.com">linux.gaming20@gmail.com</a></p>
								<p>Phone : <a href="tel:+639561564981">+639 561 564 981</a></p>
