...
<head>
	...
	<title>LRN - <?php echo "$jobtitle"; ?></title>
							...
							<div class="job-detail-wrapper">
								...
								<div class="job-detail-header text-center">
									...
									<ul class="meta-list clearfix">
										...
										<li>
											<h4 class="heading">Salary Type: </h4>
											<?php echo "$salarytype"; ?>
										</li>	
										<li>
											<h4 class="heading">Salary Rate: </h4>
											<?php echo "$salary"; ?>
										</li>	
									</ul>
								...
								<div class="job-detail-company-overview clearfix">
									...
									<div class="image">
										<?php 
										if ($complogo == null) {
										print '<center>No Employer profile</center>';
										}else{
														...
														<div class="GridLex-grid-middle">
															...
															<div class="GridLex-col-3_sm-8-xs-8_xss-12 mt-10-xss">
																<div class="job-location">
																	<i class="fa fa-map-marker text-primary"></i> <?php echo $row['barangay']; ?>
																</div>
															</div>
